...
class AgregarCuentaClienteEventUseCaseTest {
    ...
    private AgregarCuentaClienteEventUseCase useCase;

    @BeforeEach
    void setUp(){ useCase = new AgregarCuentaClienteEventUseCase(repository,bus); }
